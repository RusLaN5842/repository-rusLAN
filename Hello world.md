...
1. Делаем форк (fork) интиресующего нас аккаунта.

2. Мы делаем **git clone** Для нашей версии репозитория.

3. Мы создаем ветку с предлогаемыми изминениями. 

4. Производим все изминения в этой ветки.

5. Отправляем все изминения на свой аккаунт (git push)

6. Отрпавляем на Github появляется возможность отправлять **pull request**
